...
namespace SendImagesTool
{
    public partial class   Form1 : Form
    {
        ...
        private Action<DownloadItem> OnStudyState;
         List<DownloadItem> StudyList;
        public Form1()
        {
            InitializeComponent();
            GetLocalServer();
            ...
            StudyList = new List<DownloadItem>();
            StudyTableDGV.DataSource = sendtaskinstance.SendTaskManageInstance.DownLoadItemList; //StudyList;//new BindingList<StudySendArgs>(StudyList);
        }
