...
namespace Dicom.Imaging
{
    ...
    public abstract class ImageBase<TImage> : IImage where TImage : class 
    {
        ...
        public abstract bool Render(int components, bool bRorate90, string saveToPath);
        ...
        public abstract bool  Render(int components,System.IO.MemoryStream bw, out int w, out int h, bool bRorate90);
    }
}